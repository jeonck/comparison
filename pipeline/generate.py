#!/usr/bin/env python3
"""IT term comparison pipeline.

Reads IT terms/topics from input/term.md (one per line, inside the fenced code
...
def main() -> int:
    parser = argparse.ArgumentParser(description="IT term comparison pipeline")
